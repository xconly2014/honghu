...
class MobileDetect
{
    ...
    /**
     * Top-level device.顶级的设备
     */
    const MOBILE_GRADE_A            = 'A';

    /**
     * Mid-level device.中层设备
     */
    const MOBILE_GRADE_B            = 'B';

    /**
     * Low-level device.低级别的设备
     */
    const MOBILE_GRADE_C            = 'C';

    /**
     * Stores the version number of the current release.存储当前版本的版本号
     */
    const VERSION                   = '2.8.13';

    /**
     * A type for the version() method indicating a string return value.版本的类型()方法显示一个字符串返回值
     */
    const VERSION_TYPE_STRING       = 'text';

    /**
     * A type for the version() method indicating a float return value.版本的类型()方法显示浮动返回值
     */
    const VERSION_TYPE_FLOAT        = 'float';

    /**
     * A cache for resolved matches缓存解决比赛
     * @var array
     */
    protected $cache = array();

    /**
     * The User-Agent HTTP header is stored in here.用户代理HTTP头存储在这里
     * @var string
     */
    ...
    /**
     * The matching Regex.匹配正则表达式
     * This is good for debug.这对调试好
     * @var string
     */
    protected $matchingRegex = null;

    /**
     * The matches extracted from the regex expression.正则表达式匹配提取
     * This is good for debug.这对调试好
     * @var string
     */
    ...
    /**
     * HTTP headers that trigger the 'isMobile' detection   HTTP头,触发“isMobile”检测
     * to be true.
     *
     * @var array
     */
    ...
    /**
     * All possible HTTP headers that represent the 代表了所有可能的HTTP标头
    ...
    /**
     * The individual segments that could exist in a User-Agent string. VER refers to the regular 个人部分,可能存在于一个用户代理字符串。版本是指常规
     * expression defined in the constant self::VER.表达式中定义的常数
     *
     * @var array
     */
    ...
    /**
     * Get all possible HTTP headers that得到所有可能的HTTP标头
     * can contain the User-Agent string.可以包含用户代理字符串
     *
    ...
    /**
     * Set the User-Agent to be used.设置要使用的用户代理
     *
    ...
    /**
     * Retrieve the User-Agent.检索用户代理
     *
    ...
    /**
     * Set the detection type. Must be one of self::DETECTION_TYPE_MOBILE or设置检测类型。必须是一个self::DETECTION_TYPE_MOBILE或者
     * self::DETECTION_TYPE_EXTENDED. Otherwise, nothing is set. self::DETECTION_TYPE_EXTENDED否则,没有设置
     *
     * @deprecated since version 2.6.9
     *

...
<head>
   ...
   <script>
    ...
    function getPicture(year,month){
            ...
            $.post("Index/getPicture",{"year":year,"month":month},function(arr){
                if(arr){
        ...
        <div class="content">
            ...
            <li class="input_field required">
                <select name="year" id="month">
                    <?php $__FOR_START_9536__=1;$__FOR_END_9536__=13;for($i=$__FOR_START_9536__;$i < $__FOR_END_9536__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
                </select>
            </li>
            <li class="input_field required">

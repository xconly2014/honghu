...
class AlipaySubmit {
	...
	function __construct($gateway_url, $alipay_config){
        $this->alipay_gateway_new = $gateway_url;
		$this->alipay_config = $alipay_config;
	}
    function AlipaySubmit($url, $alipay_config) {
    	$this->__construct($url, $alipay_config);
    }

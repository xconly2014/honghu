(function(factory) {
    ...
    $.extend($.fn, {
        validate: function(options, mobile) {
            if (!this.length) {
            ...
            if (mobile) {
                ...
                options.errorContainer = "div.mobile_error";
                options.errorLabelContainer = $("#" + formId + " div.mobile_error"), options.wrapper = "li";
            } else {
                options.errorPlacement = function(error, element) {
                    error.appendTo(element.parent());
                    error.siblings("span").remove();
                };
                options.success = function(span) {

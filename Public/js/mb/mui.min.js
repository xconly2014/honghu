    ...
    function(a) {
        ...
        a.fn.on = function(b, d, e) {
            return this.each(function() {
                ...
                var n = m[d] || (m[d] = []);
                n.push(e),
                    g && (i[h(f)] = j(f, b, d, e), f.addEventListener(b, i[h(f)]), "tap" === b && f.addEventListener("click",
                        function(a) {
                            if (a.target) {
    ...
    function(a) {
        ...
        a.openWindow = function(b, c, f) {
            if (window.plus) {
                ...
                if (f.createNew !== !0 && (g = plus.webview.getWebviewById(c))) return h = a.showOptions(f.show),
                    g.show(h.aniShow, h.duration,
                        function() {
                            d(g),
                                e(g, "pagebeforeshow", !1)
            ...
            v = {
                ...
                _createPocket: function(a, c, d) {
                    ...
                    return e.className = a,
                        e.innerHTML = u.replace("{contentrefresh}", c.contentrefresh).replace("{icon}", d),
                        e
                },
    ...
    function(a, b, c, d) {
        var e = "mui-visibility",
            ...
            g = a.Scroll.extend(a.extend({
                    ...
                    refresh: function(a) {
                        a && this.finished && (this._initPullupRefresh(), this.bottomPocket.classList.remove(f), this._setCaption(this.options.up.contentdown), this.wrapper.addEventListener("scrollbottom", this), this.finished = !1),
                            this._super()
                    }
                },
                a.PullRefresh));
            ...
            m = a.Class.extend({
                        ...
                        case "dragend":
                            if (this.isDragging) {
                                ...
                                if (this.slideIn) {
                                    ...
                                    f > 0 && .5 > f && "right" === e ? this.openPercentage(0) : f > .5 && "left" === e ? this.openPercentage(100) : 0 > f && f > -.5 && "left" === e ? this.openPercentage(0) : "right" === e && 0 > f && f > -.5 ? this.openPercentage(0) : .5 > f && "right" === e ? this.openPercentage( - 100) : "right" === e && f >= 0 && (f >= .5 || d.flick) ? this.openPercentage(100) : "left" === e && 0 >= f && ( - .5 >= f || d.flick) ? this.openPercentage( - 100) : this.openPercentage(0),
                ...
                close: function() {
                    this._initOffCanvasVisible(),
                        this.slideIn && (this.scroller = this.wrapper.querySelector("." + f + "." + j) || this.wrapper.querySelector("." + e + "." + j)),
                        this.scroller && (this.scroller.classList.add(k), this.openPercentage(0))
                },
                show: function(a) {
                    return this._initOffCanvasVisible(),
                        this.isShown(a) ? !1 : (a || (a = this.wrapper.querySelector("." + f) ? "right": "left"), this.slideIn && (this.scroller = "right" === a ? this.offCanvasRight: this.offCanvasLeft), this.scroller && (this.scroller.classList.add(k), this.openPercentage("left" === a ? 100 : -100)), !0)
                },
                toggle: function(a) {
                    var b = a;
    ...
    function(a, b, c) {
        ...
        k.prototype.init = function() {
            ...
            k.prototype.toggle = function() {
                ...
                b.contains(f) ? (b.remove(f), this.handle.style.webkitTransform = "translate(0,0)") : (b.add(f), this.handle.style.webkitTransform = "translate(" + this.handleX + "px,0)"),
        ...
        var d = "mui-icon",
            ...
            r = function(a, b) {
                this.element = a,
                    ...
                    ~this.options.actions.indexOf("slider") ? (this.sliderActionClass = j + " " + k, this.sliderActionSelector = p) : (~this.options.actions.indexOf("clear") && (this.clearActionClass = d + " " + e + " " + k, this.clearActionSelector = m), ~this.options.actions.indexOf("speech") && (this.speechActionClass = d + " " + f, this.speechActionSelector = n), ~this.options.actions.indexOf("search") && (this.searchActionClass = i, this.searchActionSelector = o)),
                    this.init()
            };
        ...
        var b = "ontouchstart" in document,
            ...
            i = a.Numbox = a.Class.extend({
                init: function(b, c) {
                    ...
                    d.holder = b,
                        d.holder.__numbox_inited || (d.holder.__numbox_inited = !0, c = c || {},
                            c.step = parseInt(c.step || 1), d.options = c, d.input = a.qsa("." + h, d.holder)[0], d.plus = a.qsa("." + f, d.holder)[0], d.minus = a.qsa("." + g, d.holder)[0], d.checkValue(), d.initEvent())
                },
                initEvent: function() {
                    var b = this;
